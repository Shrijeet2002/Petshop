<%-- 
    Document   : Cat
    Created on : May 18, 2023, 12:47:43 PM
    Author     : shrijeet
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <header class="bg-dark py-5" style="background-image: url('./assets/animals-gec8de8ccb_1920.jpg');background-repeat: no-repeat;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder" style="font-family:verdana">Cattery</h1>
        ...
        <section class="py-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/siamesecat.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Siamese Cat</h5>
                                    <!-- Product price-->
                                    $40.00 
                                </div>
                            </div>
           ...
           <input type='hidden' value='Siamese Cat' name='productName' id='productName' />
          ...
          <button class="btn btn-warning" type='submit'  style="width: 100%;font-size: 1.3rem;font:bold" id='buy'>Buy Now</button>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/russianblue.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Russian Blue Cat</h5>
                                    <!-- Product reviews-->
           ...
           <input type='hidden' value='Russian Blue Cat' name='productName' id='productName' />
          ...
          <button class="btn btn-warning" type='submit'  style="width: 100%;font-size: 1.3rem;font:bold" id='buy'>Buy Now</button>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/bombay cat.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Bombay Cat</h5>
                                    <!-- Product price-->
           ...
           <input type='hidden' value='Bombay Cat' name='productName' id='productName' />
          ...
          <button class="btn btn-warning" type='submit'  style="width: 100%;font-size: 1.3rem;font:bold" id='buy'>Buy Now</button>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/balinesecat.jpg" height="180" />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Balinese Cat</h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
           ...
           <input type='hidden' value='kolkata' name='userAddress' id='userAddress' />
           <input type='hidden' value='40' name='totalAmount' id='totalAmount' />
           <input type='hidden' value='Balinese Cat' name='productName' id='productName' />
