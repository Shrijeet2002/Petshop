<%-- 
    Document   : Rabbit
    Created on : May 18, 2023, 12:45:09 PM
    Author     : shrijeet
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <header class="bg-dark py-5" style="background-image: url('./assets/animals-gec8de8ccb_1920.jpg');background-repeat: no-repeat;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder" style="font-family:verdana">Rabbit Hutch</h1>
        ...
        <section class="py-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/Brush.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Brush Rabbit</h5>
                                    <!-- Product price-->
                                    $40.00 
                                </div>
                            </div>
           ...
           <input type='hidden' value='Brush Rabbit' name='productName' id='productName' />
          ...
          <button class="btn btn-warning" type='submit'  style="width: 100%;font-size: 1.3rem;font:bold" id='buy'>Buy Now</button>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/cottontail.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Cotton Tail Rabbit</h5>
                                    <!-- Product reviews-->
           ...
           <input type='hidden' value='Cotton Tail Rabbit' name='productName' id='productName' />
          ...
          <button class="btn btn-warning" type='submit'  style="width: 100%;font-size: 1.3rem;font:bold" id='buy'>Buy Now</button>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/dwarf flop.jpg" height="200" />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Dwarf Flop Rabbit</h5>
                                    <!-- Product price-->
           ...
           <input type='hidden' value='Dwarf Flop Rabbit' name='productName' id='productName' />
          ...
          <button class="btn btn-warning" type='submit'  style="width: 100%;font-size: 1.3rem;font:bold" id='buy'>Buy Now</button>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="./assets/Swamp.jpg" height="200" />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Swamp Rabbit</h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
           ...
           <input type='hidden' value='kolkata' name='userAddress' id='userAddress' />
           <input type='hidden' value='40' name='totalAmount' id='totalAmount' />
           <input type='hidden' value='Swamp Rabbit' name='productName' id='productName' />
