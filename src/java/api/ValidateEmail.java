        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM register where email=?");
            ...
            if(ors.next()) 
            {
                ...
                final String username ="petxplore07@gmail.com";
                final String password = "gcujlancfsbztczv";
            ...
            try {
                    ...
                    vbody += "http://localhost:8080/petshop/home/newpwd.jsp?pemail="+vemail;
                    message.setText(vbody);
                    Transport.send(message);
                    response.sendRedirect("http://localhost:8080/petshop/login");
